// Animated Perlin-noise background blended with the terminal texture.
// Source: 0xkoji — https://dev.to/0xkoji/ghostty-use-fragment-shader-as-terminal-background-11g3
// Use: save as ~/.config/ghostty/shaders/perlin-noise-bg.glsl, then in your
// Ghostty config:
//   custom-shader = ~/.config/ghostty/shaders/perlin-noise-bg.glsl
